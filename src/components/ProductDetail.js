...
const ProductDetail = () => {
   ...
   const fetchProductDetail = async () => {
           const data = await fetch("https://api.escuelajs.co/api/v1/products/5");
   ...
   return (
       <div className='flex px-10 flex-col justify-between lg:flex-row gap-16 lg:items-center'>
           ...
           <div className='flex flex-col gap-4 lg:w-2/4'>
               ...
               <div className='flex flex-row items-center gap-12'>
                   <button className='bg-black text-white font-semibold py-3 px-16  h-full'>Add to Cart</button>
               </div>
           </div>
       </div>
   )
